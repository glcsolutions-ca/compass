...
- Treat `40-infra.yml` as the separate infra validation/apply path for infra-owned changes under `platform/infra/**`, `platform/scripts/infra/**`, and the direct workflow support files it executes.
