...
function parseExecutionHost(value: string): ExecutionHost {
...
function mapEventRow(row: Record<string, unknown>): ThreadEventRecord {
  return {
...
function readTurnOutputText(turn: TurnRecord): string | null {
