...
import { SidebarGroup, SidebarGroupContent, SidebarGroupLabel } from "@compass/ui/sidebar";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function ChatThreadRail({
  ...
  const refreshThreads = useCallback(async () => {
    ...
    try {
      const nextThreads = await listChatThreadsClient({
      ...
      adapters: {
        threadList: {
          ...
          onDelete: async (threadId: string) => {
            await deleteChatThreadClient({ threadId });
