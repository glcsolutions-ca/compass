...
import type { ChatTransportState } from "~/features/chat/agent-types";
...
export default function ChatRoute() {
  ...
  const surfaceState = useMemo(
    () => ({
      ...
      activityLabel:
        chatActions.modeFetcher.state !== "idle"
          ? `Switching to ${executionMode === "local" ? "local" : "cloud"} mode…`
