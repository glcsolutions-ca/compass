...
param workerAppName = 'SET_IN_GITHUB_ENV'
param workerRuntimeIdentityName = 'SET_IN_GITHUB_ENV'
param codexAppName = 'SET_IN_GITHUB_ENV'
param dynamicSessionsPoolName = 'SET_IN_GITHUB_ENV'
param dynamicSessionsExecutorIdentityName = 'SET_IN_GITHUB_ENV'
...
param workerImage = 'SET_IN_GITHUB_ENV'
param codexImage = 'SET_IN_GITHUB_ENV'
param dynamicSessionsRuntimeImage = 'SET_IN_GITHUB_ENV'
param webSessionSecret = 'SET_IN_GITHUB_ENV'
param entraLoginEnabled = 'false'
param entraClientId = ''
param entraClientSecret = ''
param authOidcStateEncryptionKey = ''
param entraAllowedTenantIds = ''
param authDevFallbackEnabled = 'false'
param serviceBusProdNamespaceName = 'SET_IN_GITHUB_ENV'
param serviceBusAcceptanceNamespaceName = 'SET_IN_GITHUB_ENV'
param serviceBusQueueName = 'SET_IN_GITHUB_ENV'
