...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from "@compass/ui/sheet";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@compass/ui/tabs";
...
function parseTerminalChunk(event: ChatEvent): string | null {
