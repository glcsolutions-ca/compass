...
Non-deployed platform tooling remains in the repository but is not part of the required merge-queue path unless it becomes part of the deployed surface.
