export async function resolvePreflightShas({
  env = process.env,
  getCurrentSha,
  getParentSha
} = {}) {
  if (typeof getCurrentSha !== "function") {
    throw new Error("resolvePreflightShas requires getCurrentSha");
  }

  if (typeof getParentSha !== "function") {
    throw new Error("resolvePreflightShas requires getParentSha");
  }
