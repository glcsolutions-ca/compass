...
const createThreadResponse = await fetch(`${apiBaseUrl}/v1/agent/threads`, {
  method: "POST",
  headers: {
...
async function sendMessage(text) {
  const response = await fetch(`${apiBaseUrl}/v1/agent/threads/${threadId}/turns`, {
    method: "POST",
    headers: {
      "content-type": "application/json",
      cookie: sessionCookie,
...
const threadResponse = await fetch(`${apiBaseUrl}/v1/agent/threads/${threadId}`, {
  headers: {
    cookie: sessionCookie
  }
});
