...
| `collect-merge-queue-gate-metrics.mjs`    | Merge-queue throughput snapshot (queue delay, pass rates, rerun ratio). |
...
| `verify-merge-queue-gate-evidence.mjs`    | Verifies successful merge-queue evidence exists for the release SHA.    |
